...
class Archive():
    ...
    def __init__(self, utilities, params):
        ...
        self.input_directory = self.params.objective+"/2dp"
        self.output_directory = "./test/"+self.params.objective+"/2dp"
    ...
    def addToArchive(self, ind):
        ...
        if chromosome_string in self.getArchive():
            # should only be true if chromosome is new but duplicated in this generation,
            # otherwise would have been caught by assignDuplicateFitnessScores
